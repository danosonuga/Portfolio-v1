...
export function DesignProcess() {
  return (
    <section className="mx-auto w-[90%] pt-16 md:w-[80%] md:pt-24">
      ...
      <h2 className="mt-3 max-w-[720px] text-[28px] font-semibold leading-[36px] tracking-[-0.02em] text-foreground md:text-[40px] md:leading-[48px]" style={{ textWrap: "balance" } as React.CSSProperties}>
      ...
      <div className="mt-10 grid grid-cols-1 gap-y-8 md:mt-12 md:grid-cols-3 md:gap-x-16 md:gap-y-10">
        {steps.map((step, i) => (
          <div key={step.title}>
            <span className="block text-[48px] font-semibold leading-[1] tracking-[-0.02em] text-[#1A1A1A] md:text-[64px]">
